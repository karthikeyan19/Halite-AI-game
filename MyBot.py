...
while True:
    ...
    for ship in game_map.get_me().all_ships():
        ...
        if len(closest_empty_planets) > 0:
            closest_empty_planets = closest_empty_planets[0:2]
            closest_empty_planets = sorted(closest_empty_planets, key=lambda t: t.radius, reverse=True)
        ...
        # FIND SHIP TO ATTACK!
            ...
            closest_enemy_ships = closest_enemy_ships[0:2]
            closest_enemy_ships = sorted(closest_enemy_ships, key=lambda t: t.radius)           
